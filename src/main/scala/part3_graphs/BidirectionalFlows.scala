...
object BidirectionalFlows extends App {
  ...
  implicit val system = ActorSystem("BiderectionalFlows")
  ...
  val cryptoBidiGraph = RunnableGraph.fromGraph(
    GraphDSL.create() { implicit builder =>
      ...
      val decryptedSinkShape = builder.add(Sink.foreach[String](string => println(s"Encrypted: $string")))
  ...
  /* Reversable operations examples  
